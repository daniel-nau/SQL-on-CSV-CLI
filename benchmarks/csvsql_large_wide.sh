...
# Data file
data_file="../data/large_wide.csv"
table_name="large_wide"
...
# Output CSV header
echo "Query,Total Time,Number of Runs,Average Time" > csvsql_large_wide_benchmarks.csv
...
for query in "${queries[@]}"; do
    ...
    echo "\"$query\",$total_time,$num_runs,$avg_time" >> csvsql_large_wide_benchmarks.csv
done
